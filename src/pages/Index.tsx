        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 font-serif">
              Ulrim is a startup that seeks to bring talented artists who have yet to become famous to the surface 
              and offer their value to people. It collaborates with artists to create products and share pieces 
              of their values. Users can follow and interact with the artists they want.
            </p>
          </div>
        </div>
      </section>
